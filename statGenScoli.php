...
<div class="tabelJudete"><table style="width:100%">
		  ...
		  <tr>
			...
			if (isset($_GET['link']))
			{
				echo " Top 10 scoli generale judetul ".$_GET['link'];
				$jud=$_GET['link'];
		  ...
		  <tr>
			<td>
				...
				$sql = "SELECT nume_scoala,medie_scoala FROM tabel_ani_scoli WHERE (an='2015' AND nume_judet='$jud') ORDER BY medie_scoala DESC";
				...
				if(mysqli_num_rows($result)!= 0){
					while($row = mysqli_fetch_assoc($result)) {
						if($cnt<=10)
						{
							echo "<h4>".$cnt.". ".$row["nume_scoala"]."</h4>"."Media: ".$row["medie_scoala"]."<br>";
							$cnt+=1;
						}
						else break;
